...
export class GdprWarningModal extends BaseComponent {
    ...
    private onConfirm?: (action: "delete" | "anonymize", twoFAToken?: string) => void;
    private action: "delete" | "anonymize";
    private twoFactorVerification: TwoFactorVerification | null = null;

    constructor(action: "delete" | "anonymize", onConfirm?: (action: "delete" | "anonymize", twoFAToken?: string) => void) {
    ...
    private proceedWithAction(twoFAToken?: string) {
        if (this.onConfirm) {
            this.onConfirm(this.action, twoFAToken);
        }
        this.hide();
    }
