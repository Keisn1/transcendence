...
export class PlayerNamesDisplay extends BaseComponent {
    ...
    constructor() {
        ...
        this.container.querySelector<HTMLImageElement>("#image-player-1")!.src = match.player1.avatar;
        this.container.querySelector<HTMLImageElement>("#image-player-2")!.src = match.player2.avatar;
    }
